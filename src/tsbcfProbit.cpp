...
List tsbcfProbit(arma::vec y,       // True latent variable values of the response.
              ...
              double lambda=-999, double sigq=.9, double nu=3,
              double offset=0,
              ...
              bool silent_mode = false)
{
   ...
   for(size_t i=0;i<(nsim+nburn);i++) {
      ...
      //Rcpp::Rcout << "prognostic trees begin" << endl;
      ...
      //Rcpp::Rcout << "treatment trees begin" << endl;
      ...
      // Update for backfitting, using updated eta.
   ...
   return(List::create(_["yhat"]       = yhat_post,         // (nsim x n) matrix of in-sample mcmc yhats.
                       ...
                       _["sigma"]      = 1,                 // nsim-length vector of sigma draws.
